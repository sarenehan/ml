...
page = urllib.request.urlopen('http://static.pfref.com/years/2014/rushing.htm')
...
output_file_name = 'data/rb_data.csv'
...
DBSession.upload_from_csv(output_file_name, 'running_back')
